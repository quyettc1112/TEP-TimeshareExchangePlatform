    ...
    companion object {
        ...
        val notificationList = listOf(
            ...
            NotificationModel(
                ...
                typeNotification = NotificationType.NOTIFICATION, // Loại thông báo
                description = "Yêu cầu đặt phòng tại Resort Vinpearl của bạn đã được xác nhận thành công. Đừng bỏ lỡ trải nghiệm tuyệt vời tại resort này! Nhấn để xem thông tin đặt phòng chi tiết.",
                iconResId = R.raw.anim_notification, // Thay thế bằng icon thực tế của bạn
                timestamp = "5 phút trước",
                isRead = false
            ),
