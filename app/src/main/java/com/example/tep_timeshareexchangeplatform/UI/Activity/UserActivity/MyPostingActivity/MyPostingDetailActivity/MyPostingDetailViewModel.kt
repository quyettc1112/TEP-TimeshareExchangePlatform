...
class MyPostingDetailViewModel @Inject constructor(
    ...
    private val _postingDetailResponse = MutableLiveData<Resource<PostingDetailResponse>>()
    val postingDetailResponse: MutableLiveData<Resource<PostingDetailResponse>>
