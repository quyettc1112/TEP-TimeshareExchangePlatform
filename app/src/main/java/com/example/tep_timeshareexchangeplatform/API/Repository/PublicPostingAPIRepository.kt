...
class  PublicPostingAPIRepository @Inject constructor(
    ...
    suspend fun getPublicPostings(pageNo: Int, pageSize: Int, resortName: String) : Resource<PublicPostingResponse> {
        return try {
            val response = publicPostingAPIService.getPostings(pageNo, pageSize, resortName)
